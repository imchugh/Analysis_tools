...
def get_data(configs_dict):
    ...
    ext = os.path.splitext(paths_dict['data_file'])[1]
    data_input_target = os.path.join(paths_dict['data_path'],
                                     paths_dict['data_file'])
...
def main():    
    ...
    years_data_dict = data_filter.subset_datayear_from_arraydict(data_dict.copy(), 
                                                                 'date_time')                                                          
